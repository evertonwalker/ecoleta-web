...
const CreatePoint = () => {
    ...
    let [ufs, setEstados] = useState<string[]>([]);
    let [cities, setCitys] = useState<string[]>([]);
    ...
    useEffect(() => {
        axios.get<IBGECityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
            .then(resultMunicipios => {
                const cityNames = resultMunicipios.data.map(cities => cities.nome);
                setCitys(cityNames);
            });
    }, [selectedUf]);
    ...
    function handleSelectItem(id: number) {
        ...
        if (alreadySelected >= 0) {
            const filteredItens = selectedItems.filter(it => it !== id);
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <Map center={initialPosition} zoom={18.25} onClick={handleMapClick}>
                        <TileLayer
